...
.directive('flowChart', function() {
  return {
  	restrict: 'E',
  	templateUrl: "bower_components/angular-flowchart/flowchart_template.html",
  	replace: true,
  	scope: {
  		chart: "=chart",
  	},
...
// (which is possible, just not ideal).
//
.controller('FlowChartController', ['$scope', 'dragging', '$element', '$log',function FlowChartController ($scope, dragging, $element,$log) {
